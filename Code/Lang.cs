namespace DebugToolkit
{
    public static class Lang
    {
        ...
        public const string
            ...
            RANDOMITEM_ARGS = "Requires 1 (3 if from server) argument: {count} [tiers ('all'|Any comma-separated tier names):'all'] [target (player|'pinged'|'evolution'|'simulacrum'|'voidfields'):<self>]",
