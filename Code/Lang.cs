namespace DebugToolkit
{
    public static class Lang
    {
        ...
        public const string
            ...
            RANDOM_ITEM_ARGS = "Requires 1 (2 if from server) argument: random_items {Count} ({PlayerID:self}|{Playername}|\"pinged\")",
            REMOVEALLITEMS_ARGS = "Requires 0 (1 if from server) arguments: remove_all_items ({PlayerID:self}|{Playername}|\"pinged\")",
            REMOVEEQUIP_ARGS = "Requires 0 (1 if from server) arguments: remove_equip ({PlayerID:self}|{Playername}|\"pinged\")",
            REMOVEITEM_ARGS = "Requires 1 (2 if from server) argument: remove_item {localised_object_name} {Count} ({PlayerID:self}|{Playername}|\"pinged\")",
            REMOVEITEMSTACKS_ARGS = "Requires 1 (2 if from server) argument: remove_item_stacks {localised_object_name} ({PlayerID:self}|{Playername}|\"pinged\")",
