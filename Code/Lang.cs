namespace DebugToolkit
{
    public static class Lang
    {
        ...
        public const string
            ...
            CREATEPICKUP_ARGS = "Requires 1 (3 if from server) argument: {object (item|equip|drone|'lunarcoin'|'voidcoin')} [search ('item'|'equip'|'drone'|'all'|'pickup'):'all'] [itemTypesNoChanneled:'permanent'] player:<self>]",
            ...
            //GIVEITEM_ARGS = "Requires 1 (3 if from server) argument: {item} [count:1] [type ('permanent'|'temp'|'channeled'):'permanent'] [target (player|'pinged'|'evolution'|'simulacrum'|'voidfields'|'devotion'):<self>]",
            GIVEITEM_ARGS = "Requires 1 (3 if from server) argument: {item} [count:1] [itemTypes:'permanent'] [target (player|'pinged'|'evolution'|'simulacrum'|'voidfields'|'devotion'):<self>]",
            GIVEDRONE_ARGS = "Requires 1 (2 if from server) argument: {drone} [count:1] [droneTier:1] [target (player|'pinged'):<self>]",
            GIVELUNAR_ARGS = "Requires 0 arguments: [amount:1]",
            GIVEMONEY_ARGS = "Requires 1 argument: {amount} [target (player|'all')]",
            MONEY_ARGS = "Requires 0 argument: [target (player|'all')]",
            SETSTATS_ARGS = "Requires 1 argument: {amount} [target (player|'pinged'):<self>]",
            TARGET_PLAYER_PINGED = "Requires 0 argument: [target (player|'pinged'):<self>]",
            HEAL_ARGS = "Requires 1 argument: {amount} [target (player|'pinged'):<self>]",
            HURT_ARGS = "Requires 1 argument: {amount} [target (player|'pinged'):<self>] [bypassCalcs (0|1):0/false]",
            KICK_ARGS = "Requires 1 argument: {player}",
            KILLALL_ARGS = "Requires 0 arguments: [team:Monster&Void], [trueKill (0|1):0/false]",
            LISTSKIN_ARGS = "Requires 0 arguments: [selection (body|'all'|'body'|'self'):'all']",
            LISTQUERY_ARGS = "Requires 0 arguments: [query]",
            LISTMODS_ARGS = "Requires 0 arguments: [filterByRequiredByAll (0'both'|1'yes'|2'no'):0]",
            ...
            RANDOMITEM_ARGS = "Requires 1 (3 if from server) argument: {count} [tier (tier|'all'):'\"0,1,2,4\"'] [itemTypes:'permanent'] [target (player|'pinged'|'evolution'|'simulacrum'|'voidfields'|'devotion'):<self>]",
            RANDOMITEM2_ARGS = "Requires 1 (3 if from server) argument: {count} [allowLunar (0|1):0/false] [allowVoid (0|1):0/false] [target (player|'pinged'|'evolution'|'simulacrum'|'voidfields'|'devotion'):<self>]",
        ...
        public const string
            ...
            BUDDHA_HELP2 = "Enemies become immortal, but remain attackable. " + ENABLE_ARGS,
            ...
            REMOVEALLDRONES_HELP = "Removes all drones from the target. " + KICK_ARGS,
            KILL_ALL_MINIONS_HELP = "Kills all minions owned by target. " + KICK_ARGS,
            ...
            NOCOOLDOWN_HELP = "Toggles skill cooldowns of the target. " + TARGET_PLAYER_PINGED,
            ...
            TRUEKILL_HELP = "Kill the entity bypassing revives, buddha & godmode    . " + TRUEKILL_ARGS,
            TOGGLETIME_HELP = "Toggles timescale between 0 and normal value. "
            ;

        // Messages
        public const string
            CREATEPICKUP_AMBIGIOUS_4 = "Found multiple results. Please be more precise or specify using 'item', 'equip', 'drone'\n{0}",
            //CREATEPICKUP_AMBIGIOUS_3 = "Could not choose between {0}\n{1}\n{2}, please be more precise. Specify in second argument using 'item', 'equip' or 'drone'",
            //CREATEPICKUP_AMBIGIOUS_2 = "Could not choose between {0}\n{1}, please be more precise. Specify in second argument using 'item', 'equip' or 'drone'",
            ...
            GIVEITEM = "Gave {0} {1} to {2}.", //Amount ItemType Item Target
            GIVEBUFF = "Gave {0} {1} to {2}.",
