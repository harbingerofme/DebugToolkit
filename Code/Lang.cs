namespace DebugToolkit
{
    public static class Lang
    {
        ...
        public const string
            ...
            DUMPBUFFS = "List the buffs/debuffs of all spawned bodies. " + NO_ARGS,
            DUMPINVENTORIES = "List the inventory items and equipment of all spawned bodies. " + NO_ARGS,
            DUMPSTATE = "List the current stats, entity state, and skill cooldown of a specified body. " + DUMPSTATE_ARGS,
            DUMPSTATS = "List the base stats of a specific body. " + DUMPSTATS_ARGS,
