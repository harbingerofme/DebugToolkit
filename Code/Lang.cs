namespace DebugToolkit
{
    public static class Lang
    {
        ...
        public const string
            ...
            CHARGEZONE_ARGS = "Requires 0 argument: [charge:100]",
            CREATEPICKUP_ARGS = "Requires 1 (3 if from server) argument: {object (item|equip|drone|'lunarcoin'|'voidcoin')} [search:'all'] [pickup_type:'permanent'] player:<self>]",
            ...
            REMOVEALLMINIONS_ARGS = "Requires 0 (1 if from server) argument: [target (player|'pinged'):<self>]",
            ...
            LOADOUTSKIN_SHORT_ARGS = "Requires 1 argument: {skin_index}",
            LOADOUTSKILL_ARGS = "Requires 3 argument:  {bodyIndex|'self'} {skill_slot} {skill_variant}",
            LOADOUTSKILL_SHORT_ARGS = "Requires 2 argument: {skill_slot} {skill_variant}",
            ...
            SPAWNMINION_ARGS = "Requires 1 argument: {ai} [count:1] [droneTier:1] [braindead (0|1):0/false]",
        ...
        public const string
            ...
            REMOVEALLMINIONS_HELP = "Destroys the targets minions, leaving no bodies or broken ones. " + REMOVEALLMINIONS_ARGS,
            ...
            LOADOUTSKILL_HELP = "Sets your loadout's skill variant for the given slot.  " + LOADOUTSKILL_SHORT_ARGS,
            ...
            GIVEALLITEMS_HELP = "Gives all items of the tier to the target. " + GIVEALLITEMS_ARGS,
            ...
            SPAWNMINION_HELP = "Spawns the specified CharacterMaster as a minion. " + SPAWNMINION_ARGS,
        ...
        public const string
            ...
            REMOVED_MINIONS = "Removed {0} minions from {1}.",
