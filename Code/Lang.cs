namespace DebugToolkit
{
    public static class Lang
    {
        ...
        public const string
            ...
            PERM_ENABLE_ARGS = "Requires 0 or 1 arguments: [value (0|1)]",
            PERM_MOD_ARGS = "Requires 2 arguments: {permission_level} {player}",
            POSTSOUNDEVENT_ARGS = "Requires 1 argument: {event_name}",
            PREVENT_PROFILE_WRITING_ARGS = "Requires 0 or 1 arguments [flag (0|1)]",
            RANDOMITEM_ARGS = "Requires 1 (3 if from server) argument: {count} [droptable (droptable|'all'):'all'] [target (player|'pinged'|'evolution'|'simulacrum'|'voidfields'):<self>]",
            ...
            REMOVEALLITEMS_ARGS = "Requires 0 (1 if from server) arguments: [target (player|'pinged'|'evolution'|'simulacrum'|'voidfields'):<self>]",
            ...
            REMOVEEQUIP_ARGS = "Requires 0 (1 if from server) arguments: [target (player|'pinged'|'evolution'|'simulacrum'|'voidfields'):<self>]",
            REMOVEITEMSTACKS_ARGS = "Requires 1 (2 if from server) argument: {item} [target (player|'pinged'|'evolution'|'simulacrum'|'voidfields'):<self>]",
            RESPAWN_ARGS = "Requires 0 (1 if from server) arguments: [player:<self>]",
            RESTOCKEQUIP_ARGS = "Requires 0 (2 if from server) arguments: [count:1] *[target (player|'pinged'|'evolution'|'simulacrum'|'voidfields'):<self>]",
        ...
        public const string
            ...
            PREVENT_PROFILE_WRITING_HELP = "Prevent saving the user profile to avoid bogus data. " + PREVENT_PROFILE_WRITING_ARGS,
