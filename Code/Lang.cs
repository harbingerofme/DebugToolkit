namespace DebugToolkit
{
    public static class Lang
    {
        ...
        public const string
            ...
            CREATEPICKUP_ARGS = "Requires 1 (3 if from server) argument: {object (item|equip|drone|'lunarcoin'|'voidcoin')} [search ('item'|'equip'|'drone'|'all'|'pickup'):'all'] [type ('permanent'|'temp'):'permanent'] player:<self>]",
            ...
            GIVEDRONE_ARGS = "Requires 1 (2 if from server) argument: {drone} [count:1] [tier:1] [target (player|'pinged'):<self>]",
            ...
            LISTMODS_ARGS = "Requires 0 arguments: [filterByRequiredByAll (0|1):0/false]",
            ...
            RANDOMITEM_ARGS = "Requires 1 (3 if from server) argument: {count} [tier (tier|'all'):'\"0,1,2,4\"'] [type ('permanent'|'temp'):'permanent'] [target (player|'pinged'|'evolution'|'simulacrum'|'voidfields'|'devotion'):<self>]",
        ...
        public const string
            ...
            NOCOOLDOWN_HELP = "Toggles your Skill Cooldowns",
            ...
            TRUEKILL_HELP = "Ignore Dio's and God and kill the entity. " + TRUEKILL_ARGS
            ;
