namespace DebugToolkit
{
    public static class Lang
    {
        ...
        public const string
            ...
            GIVEITEM_ARGS = "Requires 1 (3 if from server) argument: {item} [count:1] [type ('permanent'|'temp'):'permanent'] [target (player|'pinged'|'evolution'|'simulacrum'|'voidfields'|'devotion'):<self>]",
