...
namespace DebugToolkit.Commands
{
    static class Macros
    {
        ...
        private static void Invoke(NetworkUser user, string commandname, params object[] args)
        {
            ...
            Invoke(user, commandname, arguments);
        }
    }
}
